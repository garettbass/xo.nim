...
type D3D_DRIVER_TYPE* {.size: sizeof(cint).} = enum
...
type D3D_FEATURE_LEVEL* {.size: sizeof(cint).} = enum
...
type D3D_PRIMITIVE_TOPOLOGY* {.size: sizeof(cint).} = enum
...
type D3D10_PRIMITIVE_TOPOLOGY* {.size: sizeof(cint).} = enum
...
type D3D11_PRIMITIVE_TOPOLOGY* {.size: sizeof(cint).} = enum
...
type D3D_PRIMITIVE* {.size: sizeof(cint).} = enum
  ...
  # note this value is different in win10,
  # MSDN lists the 8.1 values so I'm using those:
...
type D3D10_PRIMITIVE* {.size: sizeof(cint).} = enum
...
type D3D11_PRIMITIVE* {.size: sizeof(cint).} = enum
...
type D3D_SRV_DIMENSION* {.size: sizeof(cint).} = enum
...
type D3D10_SRV_DIMENSION* {.size: sizeof(cint).} = enum
...
type D3D10_1_SRV_DIMENSION* {.size: sizeof(cint).} = enum
...
type D3D11_SRV_DIMENSION* {.size: sizeof(cint).} = enum
...
type D3D_SHADER_MACRO* = object
  Name*       : cstring
  Definition* : cstring

type LPD3D_SHADER_MACRO* = ptr D3D_SHADER_MACRO

comapi ID3D10Blob of IUnknown:
  proc QueryInterface(riid: ptr IID; ppvObject: ptr pointer): HRESULT
  proc AddRef(): uint32
  proc Release(): uint32
  proc GetBufferPointer(): pointer
  proc GetBufferSize(): uint

type LPD3Dmkd10BLOB* = ptr ID3D10Blob
type ID3DBlob*    = ID3D10Blob
type LPD3DBLOB*   = ptr ID3DBlob

type D3D_INCLUDE_TYPE* {.size: sizeof(cint).} = enum
  D3D_INCLUDE_LOCAL
  D3D_INCLUDE_SYSTEM

type D3D10_INCLUDE_TYPE* {.size: sizeof(cint).} = enum
  D3D10_INCLUDE_LOCAL  = D3D_INCLUDE_LOCAL
  D3D10_INCLUDE_SYSTEM = D3D_INCLUDE_SYSTEM

comapi ID3DInclude:
  proc Open(IncludeType: D3D_INCLUDE_TYPE; pFileName: cstring; pParentData: pointer; ppData: ptr pointer; pBytes: ptr uint32): HRESULT
  proc Close(pData: pointer): HRESULT

type LPD3DINCLUDE* = ptr ID3DInclude

type D3D_SHADER_VARIABLE_CLASS* {.size: sizeof(cint).} = enum
  D3D_SVC_SCALAR
  D3D_SVC_VECTOR
  D3D_SVC_MATRIX_ROWS
...
type D3D10_SHADER_VARIABLE_CLASS* {.size: sizeof(cint).} = enum
...
type D3D11_SHADER_VARIABLE_CLASS* {.size: sizeof(cint).} = enum
  D3D11_SVC_INTERFACE_CLASS   = D3D_SVC_INTERFACE_CLASS
  D3D11_SVC_INTERFACE_POINTER = D3D_SVC_INTERFACE_POINTER

type D3D_SHADER_VARIABLE_FLAGS* {.size: sizeof(cint).} = enum
  D3D_SVF_USERPACKED          = 1
  D3D_SVF_USED                = 2
  D3D_SVF_INTERFACE_POINTER   = 4
  D3D_SVF_INTERFACE_PARAMETER = 8

type D3D10_SHADER_VARIABLE_FLAGS* {.size: sizeof(cint).} = enum
  D3D10_SVF_USERPACKED = D3D_SVF_USERPACKED
  D3D10_SVF_USED       = D3D_SVF_USED

type D3D11_SHADER_VARIABLE_FLAGS* {.size: sizeof(cint).} = enum
  D3D11_SVF_INTERFACE_POINTER   = D3D_SVF_INTERFACE_POINTER
  D3D11_SVF_INTERFACE_PARAMETER = D3D_SVF_INTERFACE_PARAMETER

type D3D_SHADER_VARIABLE_TYPE* {.size: sizeof(cint).} = enum
  D3D_SVT_VOID
  D3D_SVT_BOOL
  D3D_SVT_INT
  D3D_SVT_FLOAT
...
type D3D10_SHADER_VARIABLE_TYPE* {.size: sizeof(cint).} = enum
...
type D3D11_SHADER_VARIABLE_TYPE* {.size: sizeof(cint).} = enum
...
type D3D_SHADER_INPUT_FLAGS* {.size: sizeof(cint).} = enum
...
type D3D10_SHADER_INPUT_FLAGS* {.size: sizeof(cint).} = enum
...
type D3D_SHADER_INPUT_TYPE* {.size: sizeof(cint).} = enum
  D3D_SIT_CBUFFER
  D3D_SIT_TBUFFER
  D3D_SIT_TEXTURE
  D3D_SIT_SAMPLER
...
type D3D10_SHADER_INPUT_TYPE* {.size: sizeof(cint).} = enum
...
type D3D11_SHADER_INPUT_TYPE* {.size: sizeof(cint).} = enum
...
type D3D_SHADER_CBUFFER_FLAGS* {.size: sizeof(cint).} = enum
  D3D_CBF_USERPACKED = 1

type D3D10_SHADER_CBUFFER_FLAGS* {.size: sizeof(cint).} = enum
  D3D10_CBF_USERPACKED = D3D_CBF_USERPACKED

type D3D_CBUFFER_TYPE* {.size: sizeof(cint).} = enum
  D3D_CT_CBUFFER
  D3D_CT_TBUFFER
  D3D_CT_INTERFACE_POINTERS
  D3D_CT_RESOURCE_BIND_INFO

type D3D10_CBUFFER_TYPE* {.size: sizeof(cint).} = enum
  D3D10_CT_CBUFFER = D3D_CT_CBUFFER
  D3D10_CT_TBUFFER = D3D_CT_TBUFFER

type D3D11_CBUFFER_TYPE* {.size: sizeof(cint).} = enum
  D3D11_CT_CBUFFER            = D3D_CT_CBUFFER
  D3D11_CT_TBUFFER            = D3D_CT_TBUFFER
  D3D11_CT_INTERFACE_POINTERS = D3D_CT_INTERFACE_POINTERS
  D3D11_CT_RESOURCE_BIND_INFO = D3D_CT_RESOURCE_BIND_INFO

type D3D_NAME* {.size: sizeof(cint).} = enum
...
type D3D10_NAME* {.size: sizeof(cint).} = enum
...
type D3D11_NAME* {.size: sizeof(cint).} = enum
...
type D3D_RESOURCE_RETURN_TYPE* {.size: sizeof(cint).} = enum
...
type D3D10_RESOURCE_RETURN_TYPE* {.size: sizeof(cint).} = enum
...
type D3D11_RESOURCE_RETURN_TYPE* {.size: sizeof(cint).} = enum
...
type D3D_REGISTER_COMPONENT_TYPE* {.size: sizeof(cint).} = enum
  D3D_REGISTER_COMPONENT_UNKNOWN
  D3D_REGISTER_COMPONENT_UINT32
  D3D_REGISTER_COMPONENT_SINT32
  D3D_REGISTER_COMPONENT_FLOAT32

type D3D10_REGISTER_COMPONENT_TYPE* {.size: sizeof(cint).} = enum
...
type D3D_TESSELLATOR_DOMAIN* {.size: sizeof(cint).} = enum
  D3D_TESSELLATOR_DOMAIN_UNDEFINED
  D3D_TESSELLATOR_DOMAIN_ISOLINE
  D3D_TESSELLATOR_DOMAIN_TRI
  D3D_TESSELLATOR_DOMAIN_QUAD

type D3D11_RESSELATOR_DOMAIN* {.size: sizeof(cint).} = enum
...
type D3D_TESSELLATOR_PARTITIONING* {.size: sizeof(cint).} = enum
...
type D3D11_TESSELATOR_PARTITIONING* {.size: sizeof(cint).} = enum
...
type D3D_TESSELLATOR_OUTPUT_PRIMITIVE* {.size: sizeof(cint).} = enum
...
type D3D11_TESSELATOR_OUTPUT_PRIMITIVE* {.size: sizeof(cint).} = enum
...
type D3D_MIN_PRECISION* {.size: sizeof(cint).} = enum
...
type D3D_INTERPOLATION_MODE* {.size: sizeof(cint).} = enum
...
type D3D_PARAMETER_FLAGS* {.size: sizeof(cint).} = enum
  D3D_PF_NONE = 0,
  D3D_PF_IN   = 0x1,
  D3D_PF_OUT  = 0x2,
